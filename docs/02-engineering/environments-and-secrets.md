...
| `POSTGRES_URL` | **Yes** | Session-pooler Postgres URL (migrations), set by the integration; the non-pooling direct host is IPv6-only and unreachable from Vercel builds |
